...
import (
	...
	"github.com/foax/aoc2023/internal/day14"
	"github.com/foax/aoc2023/internal/day15"
	"github.com/foax/aoc2023/internal/day16"
)
...
func Execute() {
	...
	case "day14":
		day14.Execute(scanner)
	case "day15":
		day15.Execute(scanner)
	case "day16":
		day16.Execute(scanner)
	default:
